...
const icons = {
    ...
    cart: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><title>Cart</title><path d="M15.5,5.91H8.32L3.43,1,2.37,2.07,6.2,5.91H.5a.5.5,0,0,0-.5.5v.5a.5.5,0,0,0,.5.5H.8a1.35,1.35,0,0,0,.11.34l2.88,5.94a1.62,1.62,0,0,0,1.39.88h5.64a1.62,1.62,0,0,0,1.39-.88l2.88-5.94a1.35,1.35,0,0,0,.11-.34h.3a.5.5,0,0,0,.5-.5v-.5A.5.5,0,0,0,15.5,5.91ZM5.89,12.25a.47.47,0,0,1-.42.5.47.47,0,0,1-.41-.5V9a.46.46,0,0,1,.41-.5.46.46,0,0,1,.42.5Zm2.52,0a.46.46,0,0,1-.41.5.46.46,0,0,1-.41-.5V9A.46.46,0,0,1,8,8.46a.46.46,0,0,1,.41.5Zm2.53,0a.47.47,0,0,1-.41.5.47.47,0,0,1-.42-.5V9a.42.42,0,1,1,.83,0Z" transform="translate(0 1)" /></svg>,
};
