...
const icons = {
    ...
    cart: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><title>Cart</title><path d="M15.5,6.32H13.1l-2.86-5.1a.68.68,0,0,0-.93-.09c-.36.2-.54.59-.39.85l2.46,4.34H4.62L7.08,2c.15-.26,0-.65-.39-.85a.68.68,0,0,0-.93.09L2.9,6.32H.5a.5.5,0,0,0-.5.5v.5a.5.5,0,0,0,.5.5H.8a1.35,1.35,0,0,0,.11.34L3.79,14.1A1.62,1.62,0,0,0,5.18,15h5.64a1.62,1.62,0,0,0,1.39-.88l2.88-5.94a1.35,1.35,0,0,0,.11-.34h.3a.5.5,0,0,0,.5-.5v-.5A.5.5,0,0,0,15.5,6.32Z" transform="translate(0 1)" /></svg>,
};
