...
const icons = {
    ...
    cart: <svg id="Cart" data-name="Cart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M14.82,6.6H10.15V1.84A6,6,0,0,0,8,1.52a6.33,6.33,0,0,0-2.13.38V6.6H1.18a.47.47,0,0,0-.46.46v.45A.47.47,0,0,0,1.18,8h.27a1.6,1.6,0,0,0,.1.31l2.62,5.4a1.48,1.48,0,0,0,1.27.8h5.12a1.48,1.48,0,0,0,1.27-.8l2.62-5.4a1.6,1.6,0,0,0,.1-.31h.27a.47.47,0,0,0,.46-.46V7.06A.47.47,0,0,0,14.82,6.6Z" /></svg>,
};
