...
const icons = {
    ...
    cart: <svg id="Cart" data-name="cart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M14.82,6.72h-2L11.22,2.08a1,1,0,0,0-1.28-.62l-.27.1a1,1,0,0,0-.62,1.27L10.4,6.72H5.6L7,2.83a1,1,0,0,0-.62-1.27l-.27-.1a1,1,0,0,0-1.28.62L3.17,6.72h-2a.46.46,0,0,0-.46.45v.46a.46.46,0,0,0,.46.45h.27a1.41,1.41,0,0,0,.1.31L4.17,13.8a1.47,1.47,0,0,0,1.27.79h5.12a1.47,1.47,0,0,0,1.27-.79l2.62-5.41a1.41,1.41,0,0,0,.1-.31h.27a.46.46,0,0,0,.46-.45V7.17A.46.46,0,0,0,14.82,6.72Z" /></svg>,
};
