...
const icons = {
    ...
    cart: <svg id="Cart" data-name="Cart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M14.82,6.78H9.27V1.45a5.6,5.6,0,0,0-2.49,0V6.78H1.18a.47.47,0,0,0-.46.46v.45a.47.47,0,0,0,.46.46h.27a1.6,1.6,0,0,0,.1.31l2.62,5.4a1.48,1.48,0,0,0,1.27.8h5.12a1.48,1.48,0,0,0,1.27-.8l2.62-5.4a1.6,1.6,0,0,0,.1-.31h.27a.47.47,0,0,0,.46-.46V7.24A.47.47,0,0,0,14.82,6.78Z" transform="translate(-0.72 -1.32)" /></svg>,
};
